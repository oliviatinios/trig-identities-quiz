    ...
    (case model.question of
        Question1 ->
            (case model.step of
                Step1 ->
                    ...
                    , text "Question 1" |> size 16 |> bold |> filled darkGreen |> move ( 20, 120 )
                    , triangle 8|> filled darkGreen |> move ( 150, 125 ) |> notifyTap GoToQuestion2
                    , triangle 8|> filled darkGreen |> rotate (degrees -60) |> move ( -50, 125 ) |> notifyTap GoToQuestion1
                    , text "Product Q1" |> size 12 |> bold |> filled darkGreen |> move ( -130, 95 )
                    ]
        ...
        Question2 ->
            (case model.step of
                Step1 ->
                    [ rectangle 400 290 |> filled blank |> addOutline (solid 2) darkGreen |> move ( 55, 0 )
                    , text "Question 2" |> size 16 |> bold |> filled darkGreen |> move ( 20, 120 )
                    , triangle 8|> filled darkGreen |> rotate (degrees -60) |> move ( -50, 125 ) |> notifyTap GoToQuestion1
                    , text "Product Q2" |> size 12 |> bold |> filled darkGreen |> move ( -130, 95 )
                    ]
